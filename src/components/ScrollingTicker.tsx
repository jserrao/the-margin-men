const tickerItems = [
  { icon: 'lucide:database', text: 'MARGIN DURABILITY' },
  { icon: 'lucide:sliders', text: 'PRICING STRATEGY' },
  { icon: 'lucide:trending-up', text: 'COGS DECOMPOSITION' },
  { icon: 'lucide:shield-check', text: 'REVENUE QUALITY ANALYSIS' },
  { icon: 'lucide:zap', text: 'ARR SUSTAINABILITY' },
  { icon: 'lucide:server', text: 'EXECUTIVE TRAINING' },
];
...
export function ScrollingTicker() {
  return (
    <section className="border-white/[0.03] overflow-hidden bg-[#050505]/50 border-y py-6 backdrop-blur-sm relative z-10 w-full mb-32">
      {/* Mask to fade edges */}
